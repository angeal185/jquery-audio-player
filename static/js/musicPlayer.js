(function($){
  jQuery.fn.MusicPlayer = function(options){
    options = $.extend({
      shuffle:false,
      autoplay:false,
      accentColor:"#5d1dce",
    ...
    var MusicPlayer = function(){
		...
		var template = '\
			<div id="mPlayer" class="custom">\
				<div class="streamCenter">\
		...
		var accentCSS = '\
				<style>\
					...
					#mPlayer.custom .list li.jp-playlist-current h6 a{color:'+options.accentColor+';}\
					...
					#mPlayer.custom .list li.jp-playlist-current .controls {border: 3px solid '+options.accentColor+';}\
				</style>\
				';
		...
		if (!options.roundedCorners) { $('#mPlayer').addClass('sharpen'); }
		if (options.veryThin) { $('#mPlayer').addClass('veryThin'); }
		...
		function rebuildPl(event){
			...
			$(JPlaylist.cssSelector.cssSelectorAncestor + " .jp-playlist li, "+JPlaylist.cssSelector.cssSelectorAncestor+" .playControls .new-jp-play, "+JPlaylist.cssSelector.cssSelectorAncestor+" .playControls .new-jp-pause").unbind('click',goPlaying).bind('click',goPlaying);
