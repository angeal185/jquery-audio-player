...
(function(b, f) {
    jPlayerPlaylist = function(a, c, d) {
        ...
        this.cssSelector.title = this.cssSelector.cssSelectorAncestor + " .audio-title";
        this.cssSelector.playlist = this.cssSelector.cssSelectorAncestor + " .jq-playlist";
    ...
    jPlayerPlaylist.prototype = {
        ...
        _options: {
            playlistOptions: {
                ...
                removeTime: "fast",
                shuffleTime: "slow",
                itemClass: "jq-playlist-item",
                freeGroupClass: "jp-free-media",
                freeItemClass: "jq-playlist-item-free",
                removeItemClass: "jq-playlist-item-remove"
            }
        },
        option: function(a, b) {
        ...
        _createListItem: function(a) {
            ...
            d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + a.title + (a.artist ?
                " <span class='audio-artist'>by " + a.artist + "</span>" : "") + "</a>";
            return d += "</div></li>"
        },
        ...
        _highlight: function(a) {
            this.playlist.length && a !== f && (b(this.cssSelector.playlist + " .jq-playlist-current").removeClass("jq-playlist-current"), b(this.cssSelector.playlist + " li:nth-child(" + (a + 1) +
                ")").addClass("jq-playlist-current").find(".jq-playlist-item").addClass("jq-playlist-current"), b(this.cssSelector.title + " li").html(this.playlist[a].title + (this.playlist[a].artist ? " <span class='audio-artist'>by " + this.playlist[a].artist + "</span>" : "")))
        },
